...
function STT() {
    document.body.insertAdjacentHTML(
        "afterbegin",
        "<a href='#'><div id='scrolltotop'>&raquo;</div></a>"
    );
...
function initSTT() {
    ...
    console.log(">> OneLevelJS: STT initialized");
}
...
function initDRK() {
    ...
    console.log(">> OneLevelJS: DRK initialized");
}
...
function SLD() {
    ...
    console.log(">> OneLevelJS: SLD initialized");
}
...
function initMDI() {
    ...
    console.log(">> OneLevelJS: MDI initialized");
}
